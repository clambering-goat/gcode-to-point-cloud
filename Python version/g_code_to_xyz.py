...
if use_disk_cashing==False:
    g_code_lines_in_the_g_code[current_layer_is].append(((old_x_y_points),(new_x_y_points),current_z_hight))

if use_disk_cashing==True:
    out_data=str(old_x_y_points[0])+"#"+str(old_x_y_points[1])+"##"+str(new_x_y_points[0])+"#"+str(new_x_y_points[1])+"##"+str(current_z_hight)
...
if use_disk_cashing ==True:
    file_out = open("g_code_to_line_file", "w")
...
file_name="teast.gcode"
temp=g_code_to_point_cloud(file_name)
